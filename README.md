...
<p align="center">
  ...
  <p align="center">
    ...
    <br />
    <br />
    <a href="https://github.com/D3VSJ/StickyNotes/issues/new?assignees=&labels=Bug&template=bug_report.md&title=%5BBUG%5D">Report Bug</a>
    ·
    <a href="https://github.com/D3VSJ/StickyNotes/issues/new?assignees=&labels=Suggestions&template=suggestions.md&title=%5BSUGGESTION%5D">Request Feature</a>
  </p>
</p>
...
1. Clone the repo
```sh
git clone https://github.com/D3VSJ/StickyNotes
```
...
See the [open issues](https://github.com/D3VSJ/StickyNotes/issues) for a list of proposed features (and known issues).
...
Email : [D3VSJ@protonmail.com](mailto:D3VSJS@protonmail.com) &nbsp;&middot;&nbsp;
